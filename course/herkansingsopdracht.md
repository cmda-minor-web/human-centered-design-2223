# Human Centered Design - Herkansingsopdracht
...
5. Schrijf een gestructureerd testverslag met de bevindingen en wat je gaat aanpassen, pas je User Scenario aan op basis van de test 
